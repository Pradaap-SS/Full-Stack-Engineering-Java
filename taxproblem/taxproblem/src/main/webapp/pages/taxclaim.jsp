...
<h1>
<center><spring:message code="label.header" text="TMS: Tax calculation"/></center>
</h1>
...
<tr>
<td id="id1"><spring:message code="label.employee_id"
text="Emplyoee id " /></td>
...
<tr>
<td id="id4"><spring:message code="label.expense_type"
text="Expense" /></td>
...
<tr>
<td id="id7"><spring:message code="label.expense_amount"
text="Amount" /></td>
<td id="id8"><form:input name="expenseAmt" path="expenseAmt" /></td>
<td id=id9><form:errors path="expenseAmt" /></td>
</tr>
<tr>
<td><input type="Submit" name="submit" value="<spring:message code="label.submit" text="Calculate Claim" />"/></td>
<td></td>
</tr>
<tr>
<td><input type="reset" name="reset" value="<spring:message code="label.reset" text="Clear" />"/></td>
<td></td>
</tr>
</table>
</form:form>
